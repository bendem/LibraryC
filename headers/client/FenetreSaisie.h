...
public slots:
    ...
    // Ajouté par un étudiant pas content...
    virtual void DisplayPage(int page);
    virtual void EmptyPage();
    virtual void RefreshRentedBooks();
    virtual void BookAvailableNotification(LIVRE[], int);
    virtual int  causedByNotConnected();
